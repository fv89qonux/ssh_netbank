            ...
            <tr>
                ...
                <td width="80">
                    <s:if test="pager.curPage > 1">
                        <a href='/ssh_bank/transaction/list?pager.curPage=1'>首页</a>&nbsp;&nbsp;
                        <a href='/ssh_bank/transaction/list?pager.curPage=${pager.curPage-1}'>上一页</a>
                    </s:if>
                </td>
                <td width="80">
                    <s:if test="pager.curPage < pager.pageCount">
                        <a href='/ssh_bank/transaction/list?pager.curPage=${pager.curPage+1}'>下一页</a>&nbsp;&nbsp;
                        <a href='/ssh_bank/transaction/list?pager.curPage=${pager.pageCount}'>尾页</a>
                    </s:if>
                </td>
                <td>
